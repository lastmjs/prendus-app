...
class PrendusUserCourses extends Polymer.Element implements ContainerElement {
    courses: Course[];
    componentId: string;
    ...
    static get is() { return 'prendus-user-courses'; }
...
window.customElements.define(PrendusUserCourses.is, PrendusUserCourses);
