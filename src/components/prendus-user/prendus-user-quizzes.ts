...
class PrendusUserQuizzes extends Polymer.Element {
  loaded: boolean;
  ...
  quizIds: string[];
  quizzes:  Quiz[];
  static get is() { return 'prendus-user-quizzes' }
...
window.customElements.define(PrendusUserQuizzes.is, PrendusUserQuizzes)
